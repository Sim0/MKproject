	...
	init:function(setting){
		...
		jQuery(function($){ //on document.ready
			...
			$sections.each(function(i){ //loop through $sections again
				...
				var $thestep=$('<div class="step disabledstep" />').data('section', i).html('Etape : '+(i+1)+'<div class="smalltext">'+$section.find('legend:eq(0)').text()+'</div>').appendTo($stepsguide)
			...
			var $paginatediv=$('<div class="formpaginate" style="overflow:hidden;"><span class="prev" style="float:left"><i class="icon-arrow-left"></i> &nbsp;&nbsp; Précédent</span> <span class="status">Step 1 of </span> <span class="next" style="float:right">Suivant &nbsp;&nbsp; <i class="icon-arrow-right"></i></span></div>')
