...
use racine\GestionTestsBundle\Form\ReponseType;
...
class ReponseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('racineGestionTestsBundle:Reponse')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('racineGestionTestsBundle:Reponse')->find($id);
     ...
     * @Method("POST")
     * @Template("racineGestionTestsBundle:Reponse:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("racineGestionTestsBundle:Reponse:edit.html.twig")
     */
