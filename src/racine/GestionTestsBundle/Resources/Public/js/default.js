...
;$(function(){
	...
	if($('#createQuizForm').length)
	{
		...
		createQuizForm.append(	'<div class="plainLine"></div><div id="quizQuestions">'+
								...
								'<a href="" class="button blueButton rounded6px">Valider Quiz</a><span id="quizSubmitStatus"></span></div>');
...
$(function(){
	...
	var quiz = {
		'generate':	function(qNumber){
			...
			this.controlButton = $('<a>',{'class':'blueButton rounded3px',href:'',html:'Valider'});
		...
		validate:function(){
			...
			{
				this.controlButton.html('Suivant').unbind('click').click(function(){
	...
	$('#quizDetails li').live('click',function(){
		...
		if(li.hasClass('wrong')){
			qIcon.attr('title','Correcte ?!');
		}
		else qIcon.attr('title','Fausse ?!');
